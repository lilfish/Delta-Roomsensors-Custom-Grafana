...
/* harmony import */ var _syntax__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../syntax */ "./public/app/plugins/datasource/cloudwatch/syntax.ts");
/* harmony import */ var _grafana_ui_src_slate_plugins_slate_prism__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @grafana/ui/src/slate-plugins/slate-prism */ "./packages/grafana-ui/src/slate-plugins/slate-prism/index.ts");
...
/* harmony import */ var app_store_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/store/store */ "./public/app/store/store.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function renderHighlightedMarkup(code, keyPrefix) {
  ...
  var grammar = (_Prism$languages$clou = prismjs__WEBPACK_IMPORTED_MODULE_3___default.a.languages['cloudwatch']) !== null && _Prism$languages$clou !== void 0 ? _Prism$languages$clou : _syntax__WEBPACK_IMPORTED_MODULE_4__["default"];
  var tokens = Object(_grafana_ui_src_slate_plugins_slate_prism__WEBPACK_IMPORTED_MODULE_5__["flattenTokens"])(prismjs__WEBPACK_IMPORTED_MODULE_3___default.a.tokenize(code, grammar));
...
var exampleCategory = Object(emotion__WEBPACK_IMPORTED_MODULE_6__["css"])(_templateObject17());
...
function (_PureComponent) {
  ...
  function LogsCheatSheet() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(LogsCheatSheet)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _this.switchToMetrics = function (query) {
      var _this$props = _this.props,
          onClickExample = _this$props.onClickExample,
      ...
      Object(app_store_store__WEBPACK_IMPORTED_MODULE_8__["dispatch"])(Object(app_features_explore_state_actionTypes__WEBPACK_IMPORTED_MODULE_7__["changeModeAction"])({
        exploreId: exploreId,
        mode: _grafana_data__WEBPACK_IMPORTED_MODULE_2__["ExploreMode"].Metrics
      }));
    ...
    value: function renderLogsCheatSheet() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "CloudWatch Logs Cheat Sheet"), CLIQ_EXAMPLES.map(function (cat) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "cheat-sheet-item__title ".concat(Object(emotion__WEBPACK_IMPORTED_MODULE_6__["cx"])(exampleCategory))
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "CloudWatch Logs Cheat Sheet"), CLIQ_EXAMPLES.map(function (cat) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "cheat-sheet-item",
            key: "item-".concat(i)
          }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", null, item.title), _this4.renderExpression(item.expr, "item-".concat(i)));
        }));
      }));
    }
  }]);
...
function (_DataSourceApi) {
      ...
      regeneratorRuntime.mark(function _callee(row) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref2 = _args.length > 1 && _args[1] !== undefined ? _args[1] : {}, _ref2$limit = _ref2.limit, limit = _ref2$limit === void 0 ? 10 : _ref2$limit, _ref2$direction = _ref2.direction, direction = _ref2$direction === void 0 ? 'BACKWARD' : _ref2$direction;
                logStreamField = null;
                logField = null;
  ...
  _createClass(CloudWatchDatasource, [{
    ...
    value: function query(options) {
      ...
      if (firstTarget.queryMode === 'Logs') {
        ...
        var queryParams = validLogQueries.map(function (target) {
          return {
            ...
            region: _this2.replace(_this2.getActualRegion(target.region), options.scopedVars, true, 'region')
          };
        });
        return this.makeLogActionRequest('StartQuery', queryParams, options.scopedVars).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["mergeMap"])(function (dataFrames) {
          return _this2.logsQuery(dataFrames.map(function (dataFrame) {
            var _ref3, _dataFrame$meta, _dataFrame$meta$custo;

            return {
              queryId: dataFrame.fields[0].values.get(0),
              region: (_ref3 = (_dataFrame$meta = dataFrame.meta) === null || _dataFrame$meta === void 0 ? void 0 : (_dataFrame$meta$custo = _dataFrame$meta.custom) === null || _dataFrame$meta$custo === void 0 ? void 0 : _dataFrame$meta$custo['Region']) !== null && _ref3 !== void 0 ? _ref3 : 'default',
              refId: dataFrame.refId,
              statsGroups: options.targets.find(function (target) {
                return target.refId === dataFrame.refId;
              }).statsGroups
            };
          }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["map"])(function (response) {
          return _this2.addDataLinksToLogsResponse(response, options);
        }));
      }

      var metricQueries = options.targets.filter(function (item) {
        var _item$expression;

        return item.queryMode !== 'Logs' && (!!item.region && !!item.namespace && !!item.metricName && !lodash__WEBPACK_IMPORTED_MODULE_2___default.a.isEmpty(item.statistics) || ((_item$expression = item.expression) === null || _item$expression === void 0 ? void 0 : _item$expression.length) > 0);
      }).map(function (item) {
        item.region = _this2.replace(_this2.getActualRegion(item.region), options.scopedVars, true, 'region');
        item.namespace = _this2.replace(item.namespace, options.scopedVars, true, 'namespace');
        item.metricName = _this2.replace(item.metricName, options.scopedVars, true, 'metric name');
        item.dimensions = _this2.convertDimensionFormat(item.dimensions, options.scopedVars);
        item.statistics = item.statistics.map(function (stat) {
          return _this2.replace(stat, options.scopedVars, true, 'statistics');
        });
        item.period = String(_this2.getPeriod(item, options)); // use string format for period in graph query, and alerting

        item.id = _this2.templateSrv.replace(item.id, options.scopedVars);
        item.expression = _this2.templateSrv.replace(item.expression, options.scopedVars); // valid ExtendedStatistics is like p90.00, check the pattern
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_2___default.a.isEmpty(metricQueries)) {
        return Promise.resolve({
          data: []
        });
      }
      ...
      var request = {
        from: (_options = options) === null || _options === void 0 ? void 0 : (_options$range = _options.range) === null || _options$range === void 0 ? void 0 : _options$range.from.valueOf().toString(),
        to: (_options2 = options) === null || _options2 === void 0 ? void 0 : (_options2$range = _options2.range) === null || _options2$range === void 0 ? void 0 : _options2$range.to.valueOf().toString(),
    ...
    value: function logsQuery(queryParams) {
      ...
      return withTeardown(this.makeLogActionRequest('GetQueryResults', queryParams).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["expand"])(function (dataFrames, i) {
        ...
        return allFramesCompleted ? Object(rxjs__WEBPACK_IMPORTED_MODULE_13__["empty"])() : _this3.makeLogActionRequest('GetQueryResults', queryParams).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["map"])(function (frames) {
        ...
        dataFrames.forEach(function (dataframe, i) {
          ...
          if ([_types__WEBPACK_IMPORTED_MODULE_12__["CloudWatchLogsQueryStatus"].Complete, _types__WEBPACK_IMPORTED_MODULE_12__["CloudWatchLogsQueryStatus"].Cancelled, _types__WEBPACK_IMPORTED_MODULE_12__["CloudWatchLogsQueryStatus"].Failed].includes((_dataframe$meta = dataframe.meta) === null || _dataframe$meta === void 0 ? void 0 : (_dataframe$meta$custo = _dataframe$meta.custom) === null || _dataframe$meta$custo === void 0 ? void 0 : _dataframe$meta$custo['Status']) && _this3.logQueries.hasOwnProperty(dataframe.refId)) {
            delete _this3.logQueries[dataframe.refId];
          }
        });
    ...
    value: function addDataLinksToLogsResponse(response, options) {
      ...
      try {
        var _loop = function _loop() {
          ...
          var range = _this4.timeSrv.timeRange();
          ...
          var encodedUrl = Object(_aws_url__WEBPACK_IMPORTED_MODULE_16__["encodeUrl"])(urlProps, _this4.getActualRegion(_this4.replace(curTarget.region, options.scopedVars, true, 'region')));
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee2(params) {
        var _ref4, _dataFrames$, _dataFrames$$fields$;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                logGroupNames = (_ref4 = (_dataFrames$ = dataFrames[0]) === null || _dataFrames$ === void 0 ? void 0 : (_dataFrames$$fields$ = _dataFrames$.fields[0]) === null || _dataFrames$$fields$ === void 0 ? void 0 : _dataFrames$$fields$.values.toArray()) !== null && _ref4 !== void 0 ? _ref4 : [];
    ...
    value: function buildCloudwatchConsoleUrl(_ref5, start, end, title, gmdMeta) {
      var region = _ref5.region,
          namespace = _ref5.namespace,
          metricName = _ref5.metricName,
          dimensions = _ref5.dimensions,
          statistics = _ref5.statistics,
      ...
      var isSearchExpression = gmdMeta && gmdMeta.length && gmdMeta.every(function (_ref6) {
      ...
      if (isSearchExpression) {
        var metrics = gmdMeta && gmdMeta.length ? gmdMeta.map(function (_ref7) {
        ...
        conf = _objectSpread({}, conf, {
          metrics: _toConsumableArray(statistics.map(function (stat) {
            return [namespace, metricName].concat(_toConsumableArray(Object.entries(dimensions).reduce(function (acc, _ref8) {
    ...
    value: function performTimeSeriesQuery(request, _ref10) {
      var _this6 = this;
      ...
      return this.awsRequest(TSDB_QUERY_ENDPOINT, request).then(function (res) {
        ...
        return Object.values(request.queries).reduce(function (_ref11, queryRequest) {
          ...
          var link = _this6.buildCloudwatchConsoleUrl(queryRequest, from.toISOString(), to.toISOString(), queryRequest.refId, queryResult.meta.gmdMeta);

          return {
            error: error || queryResult.error ? {
              message: queryResult.error
            } : null,
            data: [].concat(_toConsumableArray(data), _toConsumableArray(queryResult.series.map(function (_ref12) {
        ...
        if (/^Throttling:.*/.test(err.data.message)) {
          ...
          var regionsAffected = Object.values(request.queries).reduce(function (res, _ref13) {
            var refId = _ref13.refId,
          ...
          regionsAffected.forEach(function (region) {
            return _this6.debouncedAlert(_this6.datasourceName, _this6.getActualRegion(region));
          });
        }
    ...
    value: function transformSuggestDataFromTable(suggestData) {
      return suggestData.results['metricFindQuery'].tables[0].rows.map(function (_ref14) {
    ...
    value: function doMetricQueryRequest(subtype, parameters) {
      ...
      return this.awsRequest(TSDB_QUERY_ENDPOINT, {
        ...
        return _this7.transformSuggestDataFromTable(r);
      });
    }
  }, {
      ...
      if (makeReplacements) {
        requestParams.queries.forEach(function (query) {
          if (query.hasOwnProperty('queryString')) {
            query.queryString = _this8.replace(query.queryString, scopedVars, true);
          }

          query.region = _this8.replace(query.region, scopedVars, true, 'region');
          query.region = _this8.getActualRegion(query.region);
        });
      }
    ...
    value: function annotationQuery(options) {
      ...
      var statistics = annotation.statistics.map(function (s) {
        return _this9.templateSrv.replace(s);
      });
    ...
    value: function targetContainsTemplate(target) {
      ...
      return this.templateSrv.variableExists(target.region) || this.templateSrv.variableExists(target.namespace) || this.templateSrv.variableExists(target.metricName) || lodash__WEBPACK_IMPORTED_MODULE_2___default.a.find(target.dimensions, function (v, k) {
        return _this10.templateSrv.variableExists(k) || _this10.templateSrv.variableExists(v);
      });
    }
  }, {
    key: "testDatasource",
    ...
    value: function convertDimensionFormat(dimensions, scopedVars) {
      ...
      return Object.entries(dimensions).reduce(function (result, _ref16) {
        var _ref17 = _slicedToArray(_ref16, 2),
            key = _ref17[0],
            value = _ref17[1];

        key = _this11.replace(key, scopedVars, true, 'dimension keys');

        if (Array.isArray(value)) {
          return _objectSpread({}, result, _defineProperty({}, key, value));
        }

        var valueVar = _this11.templateSrv.getVariables().find(function (_ref18) {
          var name = _ref18.name;
          return name === _this11.templateSrv.getVariableName(value);
        });

        if (valueVar) {
          if (valueVar.multi) {
            var values = _this11.templateSrv.replace(value, scopedVars, 'pipe').split('|');

            return _objectSpread({}, result, _defineProperty({}, key, values));
          }

          return _objectSpread({}, result, _defineProperty({}, key, [_this11.templateSrv.replace(value, scopedVars)]));
        }
    ...
    value: function replace(target, scopedVars, displayErrorIfIsMultiTemplateVariable, fieldName) {
      ...
      if (displayErrorIfIsMultiTemplateVariable) {
        var variable = this.templateSrv.getVariables().find(function (_ref19) {
          var name = _ref19.name;
          return name === _this12.templateSrv.getVariableName(target);
        });
...
//# sourceMappingURL=cloudwatchPlugin.e261d51d50a2e4470ab9.js.map