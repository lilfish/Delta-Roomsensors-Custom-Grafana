...
var createUrlFromRichHistory = function createUrlFromRichHistory(query) {
  var exploreState = {
     ...
     **/
    mode: query.datasourceId === 'loki' ? _grafana_data__WEBPACK_IMPORTED_MODULE_1__["ExploreMode"].Logs : query.datasourceId === 'jaeger' ? _grafana_data__WEBPACK_IMPORTED_MODULE_1__["ExploreMode"].Tracing : _grafana_data__WEBPACK_IMPORTED_MODULE_1__["ExploreMode"].Metrics,
    ui: {
      showingGraph: true,
      showingLogs: true,
      showingTable: true
  ...
  var serializedState = Object(_explore__WEBPACK_IMPORTED_MODULE_4__["serializeStateToUrlParam"])(exploreState, true);
...
/*!******************************************************!*\
  !*** ./public/app/features/explore/state/actions.ts ***!
  \******************************************************/
/*! exports provided: addQueryRow, changeDatasource, changeMode, changeQuery, changeSize, updateTimeRange, changeRefreshInterval, clearQueries, cancelQueries, loadExploreDatasourcesAndSetDatasource, initializeExplore, loadDatasourceReady, importQueries, loadDatasource, modifyQueries, runQueries, updateRichHistory, deleteRichHistory, stateSave, updateTime, scanStart, setQueries, splitClose, splitOpen, syncTimes, toggleGraph, toggleTable, changeDedupStrategy, refreshExplore, navigateToExplore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function changeDatasource(exploreId, datasourceName) {
  return (
    /*#__PURE__*/
    function () {
      ...
      regeneratorRuntime.mark(function _callee(dispatch, getState) {
        var _currentDataSourceIns, _newDataSourceInstanc, _newDataSourceInstanc2;

        var newDataSourceInstance, currentDataSourceInstance, queries, orgId, datasourceVersion, prometheusToLoki;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 17:
                ...
                prometheusToLoki = (currentDataSourceInstance === null || currentDataSourceInstance === void 0 ? void 0 : (_currentDataSourceIns = currentDataSourceInstance.meta) === null || _currentDataSourceIns === void 0 ? void 0 : _currentDataSourceIns.name) === 'Prometheus' && ((_newDataSourceInstanc = newDataSourceInstance) === null || _newDataSourceInstanc === void 0 ? void 0 : (_newDataSourceInstanc2 = _newDataSourceInstanc.meta) === null || _newDataSourceInstanc2 === void 0 ? void 0 : _newDataSourceInstanc2.name) === 'Loki';
                dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_9__["updateDatasourceInstanceAction"])({
                  ...
                  mode: prometheusToLoki ? _grafana_data__WEBPACK_IMPORTED_MODULE_3__["ExploreMode"].Logs : undefined
                }));
                _context.next = 22;
...
function changeMode(exploreId, mode) {
  return function (dispatch) {
    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_9__["changeModeAction"])({
      exploreId: exploreId,
      mode: mode
    }));
  };
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 11:
                importedQueries = _context3.sent;
                _context3.next = 15;
                break;
...
var runQueries = function runQueries(exploreId) {
  return function (dispatch, getState) {
    ...
    var queryOptions = {
      ...
      maxDataPoints: mode === _grafana_data__WEBPACK_IMPORTED_MODULE_3__["ExploreMode"].Logs && datasourceId === 'loki' ? undefined : containerWidth,
      liveStreaming: live,
...
var stateSave = function stateSave() {
  return function (dispatch, getState) {
    ...
    urlStates.left = Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_6__["serializeStateToUrlParam"])(leftUrlState, true);
    ...
    if (split) {
      ...
      urlStates.right = Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_6__["serializeStateToUrlParam"])(rightUrlState, true);
    }
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                urlState = Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_6__["parseUrlState"])(queryState); // TODO: Instead of splitting and then setting query/datasource we may probably do it in one action call
...
//# sourceMappingURL=default~DashboardPage~SoloPanelPage~explore.e261d51d50a2e4470ab9.js.map