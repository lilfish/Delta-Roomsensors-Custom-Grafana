...
function (_PureComponent) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              provider = _this.props.datasource.languageProvider;
  ...
  _createClass(LokiCheatSheet, [{
    ...
    value: function renderLogsCheatSheet() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Loki Cheat Sheet"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    key: "renderMetricsCheatSheet",
    value: function renderMetricsCheatSheet() {
      var _this3 = this;

      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "LogQL Cheat Sheet"), LOGQL_EXAMPLES.map(function (item) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "cheat-sheet-item",
          key: item.expression
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "cheat-sheet-item__title"
        }, item.title), _this3.renderExpression(item.expression), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "cheat-sheet-item__label"
        }, item.label));
      }));
    }
    ...
    value: function render() {
      ...
      return exploreMode === _grafana_data__WEBPACK_IMPORTED_MODULE_2__["ExploreMode"].Logs ? this.renderLogsCheatSheet() : this.renderMetricsCheatSheet();
    }
  }]);
...
/* harmony import */ var _LokiExploreExtraField__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./LokiExploreExtraField */ "./public/app/plugins/datasource/loki/components/LokiExploreExtraField.tsx");
...
function LokiExploreQueryEditor(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_LokiQueryField__WEBPACK_IMPORTED_MODULE_3__["LokiQueryField"], {
    ...
    ExtraFieldElement: exploreMode === _grafana_data__WEBPACK_IMPORTED_MODULE_2__["ExploreMode"].Logs ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_LokiExploreExtraField__WEBPACK_IMPORTED_MODULE_4__["default"], {
      label: 'Line limit',
...
var LokiQueryEditor = Object(react__WEBPACK_IMPORTED_MODULE_0__["memo"])(function LokiQueryEditor(props) {
  var query = props.query,
      data = props.data,
      datasource = props.datasource,
      onChange = props.onChange,
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_LokiQueryField__WEBPACK_IMPORTED_MODULE_1__["LokiQueryField"], {
    datasource: datasource,
    query: query,
    onChange: onChange,
    onRunQuery: onRunQuery,
...
/* harmony import */ var _features_panel_panellinks_linkSuppliers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../features/panel/panellinks/linkSuppliers */ "./public/app/features/panel/panellinks/linkSuppliers.ts");
...
function makeDebugFields(derivedFields, debugText) {
  return derivedFields.filter(function (field) {
    ...
    try {
      ...
      if (field.url && value) {
        link = Object(_features_panel_panellinks_linkSuppliers__WEBPACK_IMPORTED_MODULE_4__["getLinksFromLogsField"])({
          name: '',
          type: _grafana_data__WEBPACK_IMPORTED_MODULE_5__["FieldType"].string,
          values: new _grafana_data__WEBPACK_IMPORTED_MODULE_5__["ArrayVector"]([value]),
          config: {
            links: [{
              title: '',
              url: field.url
...
function (_DataSourceApi) {
  ...
  function LokiDatasource(instanceSettings, templateSrv) {
    ...
    _this.prepareLogRowContextQueryTarget = function (row, limit, direction) {
      var query = Object.keys(row.labels).map(function (label) {
        return "".concat(label, "=\"").concat(row.labels[label], "\"");
      }).join(',');
  ...
  _createClass(LokiDatasource, [{
    ...
    value: function query(options) {
      ...
      if (options.exploreMode === _grafana_data__WEBPACK_IMPORTED_MODULE_3__["ExploreMode"].Metrics) {
        ...
        filteredTargets.forEach(function (target) {
          return subQueries.push(_this2.runRangeQuery(target, options, filteredTargets.length).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (dataQueryResponse) {
            if (options.exploreMode === _grafana_data__WEBPACK_IMPORTED_MODULE_3__["ExploreMode"].Logs && dataQueryResponse.data.find(function (d) {
              return isTimeSeries(d);
            })) {
    ...
    value: function modifyQuery(query, action) {
      ...
      switch (action.type) {
        case 'ADD_FILTER':
          {
            expression = Object(app_plugins_datasource_prometheus_add_label_to_query__WEBPACK_IMPORTED_MODULE_5__["addLabelToQuery"])(expression, action.key, action.value);
            break;
          }
...
//# sourceMappingURL=lokiPlugin.4e4fb26e4823e5183dd1.js.map