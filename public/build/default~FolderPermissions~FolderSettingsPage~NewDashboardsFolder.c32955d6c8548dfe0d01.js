...
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./reducers */ "./public/app/features/folders/state/reducers.ts");
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_1__["backendSrv"].getFolderByUid(uid);

              case 2:
                folder = _context.sent;
                dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_5__["loadFolder"])(folder));
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_1__["backendSrv"].put("/api/folders/".concat(folder.uid), {
                  title: folder.title,
              ...
              case 2:
                ...
                app_core_app_events__WEBPACK_IMPORTED_MODULE_4__["default"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["AppEvents"].alertSuccess, ['Folder saved']);
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_1__["backendSrv"].deleteFolder(uid, true);
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_1__["backendSrv"].get("/api/folders/".concat(uid, "/permissions"));

              case 2:
                permissions = _context4.sent;
                dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_5__["loadFolderPermissions"])(permissions));
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 31:
                _context5.next = 33;
                return app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_1__["backendSrv"].post("/api/folders/".concat(folder.uid, "/permissions"), {
                  items: itemsToUpdate
                });
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_6__["getBackendSrv"])().createFolder({
                  title: folderName
                });

              case 2:
                newFolder = _context8.sent;
                app_core_app_events__WEBPACK_IMPORTED_MODULE_4__["default"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["AppEvents"].alertSuccess, ['Folder Created', 'OK']);
                dispatch(Object(app_core_actions__WEBPACK_IMPORTED_MODULE_2__["updateLocation"])({
                  path: newFolder.url
                }));
...
//# sourceMappingURL=default~FolderPermissions~FolderSettingsPage~NewDashboardsFolder.c32955d6c8548dfe0d01.js.map