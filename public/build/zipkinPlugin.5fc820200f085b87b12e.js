...
function (_DataSourceApi) {
  ...
  _createClass(ZipkinDatasource, [{
    ...
    value: function query(options) {
      ...
      if (traceId) {
        return this.request("".concat(_constants__WEBPACK_IMPORTED_MODULE_5__["apiPrefix"], "/trace/").concat(traceId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(responseToDataQueryResponse));
      } else {
...
//# sourceMappingURL=zipkinPlugin.5fc820200f085b87b12e.js.map