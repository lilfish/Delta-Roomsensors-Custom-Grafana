...
/*#__PURE__*/
function () {
  AppInsightsDatasource.$inject = ["instanceSettings", "templateSrv"];

  /** @ngInject */
  function AppInsightsDatasource(instanceSettings, templateSrv) {
    ...
    switch ((_instanceSettings$jso = instanceSettings.jsonData) === null || _instanceSettings$jso === void 0 ? void 0 : _instanceSettings$jso.cloudName) {
      ...
      case 'chinaazuremonitor':
        this.baseUrl = "/chinaappinsights/".concat(this.version, "/apps/").concat(this.applicationId);
        break;
      // Azure Global

      default:
        this.baseUrl = "/appinsights/".concat(this.version, "/apps/").concat(this.applicationId);
    }
  ...
  _createClass(AppInsightsDatasource, [{
    ...
    key: "createMetricsRequest",
    value: function createMetricsRequest(item, options, target) {
              ...
              case 5:
                ...
                Object.values(data.results).forEach(function (queryRes) {
                  if (queryRes.meta && queryRes.meta.columns) {
                    ...
                    _this.logAnalyticsColumns[queryRes.refId] = lodash__WEBPACK_IMPORTED_MODULE_2___default.a.map(columnNames, function (n) {
                      return {
                        text: n,
                        value: n
                      };
                  ...
                  queryRes.series.forEach(function (series) {
                    ...
                    result.push(Object(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["toDataFrame"])(timeSerie));
                  });
                });
    ...
    value: function doQueries(queries) {
      ...
      return lodash__WEBPACK_IMPORTED_MODULE_2___default.a.map(queries, function (query) {
        return _this2.doRequest(query.url).then(function (result) {
          return {
            result: result,
            query: query
          };
...
/*#__PURE__*/
function () {
  AzureLogAnalyticsDatasource.$inject = ["instanceSettings", "templateSrv"];

  /** @ngInject */
  function AzureLogAnalyticsDatasource(instanceSettings, templateSrv) {
  ...
  _createClass(AzureLogAnalyticsDatasource, [{
    ...
    value: function getSchema(workspace) {
      ...
      var url = "".concat(this.baseUrl, "/").concat(this.templateSrv.replace(workspace, {}), "/metadata");
      return this.doRequest(url).then(function (response) {
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee2(options) {
        ...
        var queries, _ref, data, result, results, _i, _results, queryRes, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, series, timeSeries, df, url, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, field, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, table;

        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                queries = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.filter(options.targets, function (item) {
                  return item.hide !== true;
                }).map(function (target) {
                  ...
                  var query = _this.templateSrv.replace(item.query, options.scopedVars, _this.interpolateVariable);
              ...
              case 11:
                ...
                queryRes = _results[_i];
                _iteratorNormalCompletion = true;
                _didIteratorError = false;
                _iteratorError = undefined;
                _context2.prev = 16;
                _iterator = (queryRes.series || [])[Symbol.iterator]();
              ...
              case 18:
                ...
                df = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_3__["toDataFrame"])(timeSeries);
                ...
                _context2.next = 25;
                return this.buildDeepLink(queryRes);
              ...
              case 25:
                ...
                for (_iterator3 = df.fields[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                  field = _step3.value;
                  field.config.links = [{
                    url: url,
              ...
              case 64:
                ...
                for (_iterator2 = (queryRes.tables || [])[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  table = _step2.value;
                  result.push(Object(_grafana_data__WEBPACK_IMPORTED_MODULE_3__["toDataFrame"])(table));
                }
        ...
        }, _callee2, this, [[16, 52, 56, 64], [30, 34, 38, 46], [39,, 41, 45], [57,, 59, 63], [67, 71, 75, 83], [76,, 78, 82]]);
      }));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(queryRes) {
        var base64Enc, workspaceId, subscription, details, url;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                base64Enc = encodeURIComponent(queryRes.meta.encodedQuery);
                workspaceId = queryRes.meta.workspace;
                subscription = queryRes.meta.subscription;
                _context3.next = 5;
    ...
    value: function buildQuery(query, options, workspace) {
      var querystringBuilder = new _log_analytics_querystring_builder__WEBPACK_IMPORTED_MODULE_1__["default"](this.templateSrv.replace(query, {}, this.interpolateVariable), options, 'TimeGenerated');
...
/*#__PURE__*/
function () {
  AzureMonitorDatasource.$inject = ["instanceSettings", "templateSrv"];

  /** @ngInject */
  function AzureMonitorDatasource(instanceSettings, templateSrv) {
    ...
    this.baseUrl = "/".concat(this.cloudName, "/subscriptions");
    this.url = instanceSettings.url;
    this.supportedMetricNamespaces = new _supported_namespaces__WEBPACK_IMPORTED_MODULE_3__["default"](this.cloudName).get();
  }
  ...
  _createClass(AzureMonitorDatasource, [{
              ...
              case 5:
                ...
                Object['values'](data.results).forEach(function (queryRes) {
                  ...
                  queryRes.series.forEach(function (series) {
                    ...
                    result.push(Object(_grafana_data__WEBPACK_IMPORTED_MODULE_5__["toDataFrame"])(timeSerie));
                  });
                });
                return _context.abrupt("return", result);
    ...
    value: function getMetricDefinitions(subscriptionId, resourceGroup) {
      ...
      return this.doRequest(url).then(function (result) {
        ...
        return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.filter(result, function (t) {
    ...
    value: function getResourceNames(subscriptionId, resourceGroup, metricDefinition) {
      var url = "".concat(this.baseUrl, "/").concat(subscriptionId, "/resourceGroups/").concat(resourceGroup, "/resources?api-version=").concat(this.apiVersion);
      return this.doRequest(url).then(function (result) {
        if (!lodash__WEBPACK_IMPORTED_MODULE_0___default.a.startsWith(metricDefinition, 'Microsoft.Storage/storageAccounts/')) {
...
function (_DataSourceApi) {
  ...
  function Datasource(instanceSettings, templateSrv) {
    ...
    _this.azureMonitorDatasource = new _azure_monitor_azure_monitor_datasource__WEBPACK_IMPORTED_MODULE_1__["default"](instanceSettings, _this.templateSrv);
    _this.appInsightsDatasource = new _app_insights_app_insights_datasource__WEBPACK_IMPORTED_MODULE_2__["default"](instanceSettings, _this.templateSrv);
    _this.azureLogAnalyticsDatasource = new _azure_log_analytics_azure_log_analytics_datasource__WEBPACK_IMPORTED_MODULE_3__["default"](instanceSettings, _this.templateSrv);
    return _this;
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                promises = [];
                azureMonitorOptions = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.cloneDeep(options);
                appInsightsOptions = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.cloneDeep(options);
                azureLogAnalyticsOptions = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.cloneDeep(options);
                azureMonitorOptions.targets = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.filter(azureMonitorOptions.targets, ['queryType', 'Azure Monitor']);
                appInsightsOptions.targets = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.filter(appInsightsOptions.targets, ['queryType', 'Application Insights']);
                azureLogAnalyticsOptions.targets = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.filter(azureLogAnalyticsOptions.targets, ['queryType', 'Azure Log Analytics']);
              ...
              case 12:
                return _context.abrupt("return", Promise.all(promises).then(function (results) {
                  return {
      ...
      regeneratorRuntime.mark(function _callee2(options) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", this.azureLogAnalyticsDatasource.annotationQuery(options));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                return _context3.abrupt("return", aiResult);
              ...
              case 5:
                ...
                return _context3.abrupt("return", amResult);
              ...
              case 8:
                ...
                return _context3.abrupt("return", alaResult);
...
function (_QueryCtrl) {
  ...
  _createClass(AzureMonitorQueryCtrl, [{
    ...
    value: function migrateTimeGrains() {
      ...
      if (this.target.azureMonitor.timeGrains && this.target.azureMonitor.timeGrains.length > 0 && (!this.target.azureMonitor.allowedTimeGrainsMs || this.target.azureMonitor.allowedTimeGrainsMs.length === 0)) {
    ...
    value: function onMetricNameChange() {
      ...
      return this.datasource.getMetricMetadata(this.replace(this.target.subscription), this.replace(this.target.azureMonitor.resourceGroup), this.replace(this.target.azureMonitor.metricDefinition), this.replace(this.target.azureMonitor.resourceName), this.replace(this.target.azureMonitor.metricNamespace), this.replace(this.target.azureMonitor.metricName)).then(function (metadata) {
        _this3.target.azureMonitor.aggOptions = metadata.supportedAggTypes || [metadata.primaryAggType];
        _this3.target.azureMonitor.aggregation = metadata.primaryAggType;
        _this3.target.azureMonitor.timeGrains = [{
          text: 'auto',
          value: 'auto'
        }].concat(metadata.supportedTimeGrains);
        _this3.target.azureMonitor.timeGrain = 'auto';
        _this3.target.azureMonitor.allowedTimeGrainsMs = _this3.convertTimeGrainsToMs(metadata.supportedTimeGrains || []);
        _this3.target.azureMonitor.dimensions = metadata.dimensions;

        if (metadata.dimensions.length > 0) {
          _this3.target.azureMonitor.dimension = metadata.dimensions[0].value;
        }
    ...
    value: function getAppInsightsGroupBySegments(query) {
      return lodash__WEBPACK_IMPORTED_MODULE_0___default.a.map(this.target.appInsights.dimensions, function (option) {
        return {
          text: option,
          value: option
        };
...
//# sourceMappingURL=azureMonitorPlugin.7998f77d5b71d85f6e82.js.map