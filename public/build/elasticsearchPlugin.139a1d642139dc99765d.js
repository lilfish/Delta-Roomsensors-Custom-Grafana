...
var ElasticsearchQueryField =
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(ElasticsearchQueryField, _React$PureComponent);

  function ElasticsearchQueryField(props, context) {
    var _this;

    _classCallCheck(this, ElasticsearchQueryField);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ElasticsearchQueryField).call(this, props, context));
    ...
    _this.plugins = [Object(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["SlatePrism"])({
  ...
  _createClass(ElasticsearchQueryField, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["QueryField"], {
...
function (_DataSourceApi) {
  ...
  _createClass(ElasticDatasource, [{
    ...
    value: function request(method, url, data) {
      ...
      return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_7__["getBackendSrv"])().datasourceRequest(options);
    }
    /**
      ...
      try {
        for (var _iterator = targets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (target.isLogsQuery || _query_def__WEBPACK_IMPORTED_MODULE_6__["hasMetricOfType"](target, 'logs')) {
            ...
            target.metrics = [_query_def__WEBPACK_IMPORTED_MODULE_6__["defaultMetricAgg"]()]; // Setting this for metrics queries that are typed as logs
        ...
        if (sentTargets.some(function (target) {
          ...
          try {
            for (var _iterator2 = response.data[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              ...
              _this4.enhanceDataFrame(dataFrame);
            }
          } catch (err) {
    ...
    key: "enhanceDataFrame",
    value: function enhanceDataFrame(dataFrame) {
      var _this5 = this;
      ...
      if (this.dataLinks.length) {
        ...
        try {
          var _loop = function _loop() {
            ...
            var dataLink = _this5.dataLinks.find(function (dataLink) {
              return field.name && field.name.match(dataLink.field);
            });

            if (dataLink) {
              field.config = field.config || {};
              field.config.links = [].concat(_toConsumableArray(field.config.links || []), [{
                url: dataLink.url,
                title: ''
              }]);
            }
    ...
    value: function objectContainsTemplate(obj) {
      ...
      for (var _i = 0, _Object$keys = Object.keys(obj); _i < _Object$keys.length; _i++) {
        ...
        if (this.isPrimitive(obj[key])) {
          ...
          try {
            for (var _iterator6 = obj[key][Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
function () {
  ...
  _createClass(ElasticResponse, [{
    ...
    value: function processAggregationDocs(esAgg, aggDef, target, table, props) {
      ...
      try {
        for (var _iterator2 = esAgg.buckets[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function getTimeSeries() {
      ...
      for (var i = 0; i < this.response.responses.length; i++) {
        var _response = this.response.responses[i];

        if (_response.error) {
          throw this.getErrorFromElasticResponse(this.response, _response.error);
        }

        if (_response.hits && _response.hits.hits.length > 0) {
          this.processHits(_response.hits, seriesList);
        }
    ...
    value: function getLogs(logMessageField, logLevelField) {
      ...
      for (var n = 0; n < this.response.responses.length; n++) {
        ...
        if (docs.length > 0) {
          var series = createEmptyDataFrame(propNames, this.targets[0].timeField, logMessageField, logLevelField); // Add a row for each document
...
var createEmptyDataFrame = function createEmptyDataFrame(propNames, timeField, logMessageField, logLevelField) {
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["DataSourcePlugin"](_datasource__WEBPACK_IMPORTED_MODULE_1__["ElasticDatasource"]).setQueryCtrl(_query_ctrl__WEBPACK_IMPORTED_MODULE_2__["ElasticQueryCtrl"]).setConfigEditor(_configuration_ConfigEditor__WEBPACK_IMPORTED_MODULE_4__["ConfigEditor"]).setExploreLogsQueryField(_components_ElasticsearchQueryField__WEBPACK_IMPORTED_MODULE_3__["default"]).setAnnotationQueryCtrl(ElasticAnnotationsQueryCtrl);
...
//# sourceMappingURL=elasticsearchPlugin.139a1d642139dc99765d.js.map