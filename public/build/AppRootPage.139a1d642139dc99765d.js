...
/* harmony import */ var _PluginPage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./PluginPage */ "./public/app/features/plugins/PluginPage.tsx");
/* harmony import */ var app_core_nav_model_srv__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/core/nav_model_srv */ "./public/app/core/nav_model_srv.ts");
/* harmony import */ var app_core_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! app/core/core */ "./public/app/core/core.ts");
...
function (_Component) {
  ...
  function AppRootPage(props) {
    ...
    _this.state = {
      loading: true,
      nav: Object(_PluginPage__WEBPACK_IMPORTED_MODULE_7__["getLoadingNav"])()
    };
    return _this;
  }
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return Object(_PluginSettingsCache__WEBPACK_IMPORTED_MODULE_5__["getPluginSettings"])(pluginId).then(function (info) {
                  ...
                  if (error) {
                    app_core_core__WEBPACK_IMPORTED_MODULE_9__["appEvents"].emit(_grafana_data__WEBPACK_IMPORTED_MODULE_3__["AppEvents"].alertError, [error]);

                    _this2.setState({
                      nav: Object(app_core_nav_model_srv__WEBPACK_IMPORTED_MODULE_8__["getWarningNav"])(error)
                    });
              ...
              case 8:
                ...
                this.setState({
                  plugin: null,
                  loading: false,
                  nav: Object(app_core_nav_model_srv__WEBPACK_IMPORTED_MODULE_8__["getNotFoundNav"])()
                });
...
//# sourceMappingURL=AppRootPage.139a1d642139dc99765d.js.map