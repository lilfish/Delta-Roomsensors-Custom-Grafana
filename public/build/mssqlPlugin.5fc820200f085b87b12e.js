...
function (_QueryCtrl) {
  ...
  function MssqlQueryCtrl($scope, $injector) {
    ...
    _this.panelCtrl.events.on(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["PanelEvents"].dataReceived, _this.onDataReceived.bind(_assertThisInitialized(_this)), $scope);

    _this.panelCtrl.events.on(_grafana_data__WEBPACK_IMPORTED_MODULE_2__["PanelEvents"].dataError, _this.onDataError.bind(_assertThisInitialized(_this)), $scope);
...
//# sourceMappingURL=mssqlPlugin.5fc820200f085b87b12e.js.map