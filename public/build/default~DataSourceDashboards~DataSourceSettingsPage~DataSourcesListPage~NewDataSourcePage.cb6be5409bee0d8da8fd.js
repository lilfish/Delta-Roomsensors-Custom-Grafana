...
function getGrafanaCloudPhantomPlugin() {
  return {
    ...
    info: {
      ...
      logos: {
        small: 'public/img/fontys_icon.svg',
        large: 'asd'
      },
      author: {
        name: 'Grafana Labs'
...
//# sourceMappingURL=default~DataSourceDashboards~DataSourceSettingsPage~DataSourcesListPage~NewDataSourcePage.cb6be5409bee0d8da8fd.js.map