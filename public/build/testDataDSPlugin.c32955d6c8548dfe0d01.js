...
/* harmony import */ var _metricTree__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./metricTree */ "./public/app/plugins/datasource/testdata/metricTree.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _runStreams__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./runStreams */ "./public/app/plugins/datasource/testdata/runStreams.ts");
...
/* harmony import */ var app_features_templating_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/features/templating/utils */ "./public/app/features/templating/utils.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_DataSourceApi) {
  ...
  _createClass(TestDataDataSource, [{
    ...
    value: function query(options) {
      ...
      try {
        for (var _iterator = options.targets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (target.scenarioId === 'streaming_client') {
            streams.push(Object(_runStreams__WEBPACK_IMPORTED_MODULE_4__["runStream"])(target, options));
            ...
            queries.push(_objectSpread({}, target, {
              ...
              alias: app_features_templating_template_srv__WEBPACK_IMPORTED_MODULE_5__["default"].replace(target.alias || '')
            }));
          }
        }
      } catch (err) {
      ...
      if (queries.length) {
        var req = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getBackendSrv"])().datasourceRequest({
          method: 'POST',
          url: '/api/tsdb/query',
          data: {
      ...
      return rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"].apply(void 0, streams);
    }
  }, {
    ...
    value: function getScenarios() {
      return Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getBackendSrv"])().get('/api/tsdb/testdata/scenarios');
    }
  }, {
    key: "metricFindQuery",
    value: function metricFindQuery(query, options) {
      return new Promise(function (resolve, reject) {
        setTimeout(function () {
          var interpolatedQuery = app_features_templating_template_srv__WEBPACK_IMPORTED_MODULE_5__["default"].replace(query, Object(app_features_templating_utils__WEBPACK_IMPORTED_MODULE_6__["getSearchFilterScopedVar"])({
            query: query,
            wildcardChar: '*',
            options: options
          }));
          var children = Object(_metricTree__WEBPACK_IMPORTED_MODULE_2__["queryMetricTree"])(interpolatedQuery);
...
function runArrowFile(target, req) {
  ...
  if (target.stringInput && target.stringInput.length > 10) {
    try {
      var table = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["base64StringToArrowTable"])(target.stringInput);
      data = [Object(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["arrowTableToDataFrame"])(table)];
    } catch (e) {
      console.warn('Error reading saved arrow', e);
      var error = Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["toDataQueryError"])(e);
...
function runGrafanaAPI(target, req) {
  ...
  return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getBackendSrv"])().get(url).then(function (res) {
    var frame = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["ArrayDataFrame"](res);
    return {
      state: _grafana_data__WEBPACK_IMPORTED_MODULE_0__["LoadingState"].Done,
      data: [frame]
    };
...
//# sourceMappingURL=testDataDSPlugin.c32955d6c8548dfe0d01.js.map