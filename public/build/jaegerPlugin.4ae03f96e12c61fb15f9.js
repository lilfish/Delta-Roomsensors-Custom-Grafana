...
function getLabelFromTrace(trace) {
  ...
  if (rootSpan) {
    return "".concat(rootSpan.operationName, " [").concat(rootSpan.duration, " ms]");
  }
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                url = "/api/services/".concat(service, "/operations");
                _context2.prev = 2;
                _context2.next = 5;
  ...
  _createClass(JaegerDatasource, [{
    ...
    value: function query(options) {
      ...
      if (id) {
        ...
        return this._request("/api/traces/".concat(id)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
          var _response$data;
...
//# sourceMappingURL=jaegerPlugin.4ae03f96e12c61fb15f9.js.map