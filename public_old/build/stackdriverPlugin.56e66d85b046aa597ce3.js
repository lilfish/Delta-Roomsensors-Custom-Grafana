...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StackdriverMetricFindQuery; });
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types */ "./public/app/plugins/datasource/stackdriver/types.ts");
...
function () {
  function StackdriverMetricFindQuery(datasource) {
    _classCallCheck(this, StackdriverMetricFindQuery);

    this.datasource = datasource;
  }

  _createClass(StackdriverMetricFindQuery, [{
    key: "execute",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 20:
                ...
                console.error("Could not run StackdriverMetricFindQuery ".concat(query), _context.t1);
                return _context.abrupt("return", []);
...
var StackdriverAnnotationsQueryCtrl =
/*#__PURE__*/
function () {
  /** @ngInject */
  function StackdriverAnnotationsQueryCtrl() {
    _classCallCheck(this, StackdriverAnnotationsQueryCtrl);

    this.annotation.target = this.annotation.target || {};
    this.onQueryChange = this.onQueryChange.bind(this);
  }

  _createClass(StackdriverAnnotationsQueryCtrl, [{
    key: "onQueryChange",
            ...
            switch (_context.prev = _context.next) {
              ...
              case 14:
                ...
                app_core_app_events__WEBPACK_IMPORTED_MODULE_0__["default"].emit(app_types__WEBPACK_IMPORTED_MODULE_1__["CoreEvents"].dsRequestError, {
                  error: {
                    data: {
                      error: Object(_functions__WEBPACK_IMPORTED_MODULE_3__["formatStackdriverError"])(_context.t0)
                    }
                  }
                });
                return _context.abrupt("return", []);
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ */ "./public/app/plugins/datasource/stackdriver/components/index.ts");
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../functions */ "./public/app/plugins/datasource/stackdriver/functions.ts");
...
var StackdriverVariableQueryEditor =
/*#__PURE__*/
function (_PureComponent) {
  _inherits(StackdriverVariableQueryEditor, _PureComponent);

  function StackdriverVariableQueryEditor(props) {
    var _this;

    _classCallCheck(this, StackdriverVariableQueryEditor);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(StackdriverVariableQueryEditor).call(this, props));
    _this.queryTypes = [{
  ...
  _createClass(StackdriverVariableQueryEditor, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!Object(app_core_config__WEBPACK_IMPORTED_MODULE_4__["getConfig"])().featureToggles.newVariables || prevState.selectedQueryType !== this.state.selectedQueryType) {
        ...
        var query = this.queryTypes.find(function (q) {
          return q.value === _this3.state.selectedQueryType;
        });
        this.props.onChange(queryModel, "Stackdriver - ".concat(query.name));
      }
    }
  }, {
    key: "getLabels",
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types */ "./public/app/plugins/datasource/stackdriver/types.ts");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var StackdriverConfigCtrl =
/*#__PURE__*/
function () {
  StackdriverConfigCtrl.$inject = ["datasourceSrv"];

  /** @ngInject */
  function StackdriverConfigCtrl(datasourceSrv) {
    _classCallCheck(this, StackdriverConfigCtrl);
  ...
  _createClass(StackdriverConfigCtrl, [{
    key: "save",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StackdriverDatasource; });
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types */ "./public/app/plugins/datasource/stackdriver/types.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants */ "./public/app/plugins/datasource/stackdriver/constants.ts");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./api */ "./public/app/plugins/datasource/stackdriver/api.ts");
/* harmony import */ var _StackdriverMetricFindQuery__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./StackdriverMetricFindQuery */ "./public/app/plugins/datasource/stackdriver/StackdriverMetricFindQuery.ts");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var StackdriverDatasource =
/*#__PURE__*/
function (_DataSourceApi) {
  StackdriverDatasource.$inject = ["instanceSettings", "templateSrv", "timeSrv"];

  _inherits(StackdriverDatasource, _DataSourceApi);

  /** @ngInject */
  function StackdriverDatasource(instanceSettings, templateSrv, timeSrv) {
    var _this;

    _classCallCheck(this, StackdriverDatasource);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(StackdriverDatasource).call(this, instanceSettings));
    ...
    _this.api = new _api__WEBPACK_IMPORTED_MODULE_4__["default"]("".concat(instanceSettings.url, "/stackdriver/v3/projects/"));
    return _this;
  }

  _createClass(StackdriverDatasource, [{
    key: "query",
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                stackdriverMetricFindQuery = new _StackdriverMetricFindQuery__WEBPACK_IMPORTED_MODULE_5__["default"](this);
                return _context3.abrupt("return", stackdriverMetricFindQuery.execute(query));
    ...
    value: function resolvePanelUnitFromTargets(targets) {
      ...
      if (targets.length > 0 && targets.every(function (t) {
        ...
        if (_constants__WEBPACK_IMPORTED_MODULE_3__["stackdriverUnitMappings"].hasOwnProperty(targets[0].unit)) {
          // @ts-ignore
          unit = _constants__WEBPACK_IMPORTED_MODULE_3__["stackdriverUnitMappings"][targets[0].unit];
        }
      }
...
/* harmony import */ var _datasource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./datasource */ "./public/app/plugins/datasource/stackdriver/datasource.ts");
/* harmony import */ var _components_QueryEditor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/QueryEditor */ "./public/app/plugins/datasource/stackdriver/components/QueryEditor.tsx");
/* harmony import */ var _config_ctrl__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./config_ctrl */ "./public/app/plugins/datasource/stackdriver/config_ctrl.ts");
/* harmony import */ var _annotations_query_ctrl__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./annotations_query_ctrl */ "./public/app/plugins/datasource/stackdriver/annotations_query_ctrl.ts");
/* harmony import */ var _components_VariableQueryEditor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/VariableQueryEditor */ "./public/app/plugins/datasource/stackdriver/components/VariableQueryEditor.tsx");
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["DataSourcePlugin"](_datasource__WEBPACK_IMPORTED_MODULE_1__["default"]).setQueryEditor(_components_QueryEditor__WEBPACK_IMPORTED_MODULE_2__["QueryEditor"]).setConfigCtrl(_config_ctrl__WEBPACK_IMPORTED_MODULE_3__["StackdriverConfigCtrl"]).setAnnotationQueryCtrl(_annotations_query_ctrl__WEBPACK_IMPORTED_MODULE_4__["StackdriverAnnotationsQueryCtrl"]).setVariableQueryEditor(_components_VariableQueryEditor__WEBPACK_IMPORTED_MODULE_5__["StackdriverVariableQueryEditor"]);

/***/ })

}]);
//# sourceMappingURL=stackdriverPlugin.56e66d85b046aa597ce3.js.map